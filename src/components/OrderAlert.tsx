    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className="relative z-10 w-[90%] max-w-md bg-[#161A22] rounded-[32px] border border-white/10 shadow-2xl shadow-brand/20 overflow-hidden"
        >
          {/* Glow top */}
          ...
          {orderData && (
            <div className="px-8 pb-6 space-y-4">
              <div className="bg-white/5 rounded-2xl p-4 space-y-3 border border-white/5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white font-bold">{orderData.name}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[10px] font-black text-white/30 uppercase tracking-widest">Delivery to</p>
                    <p className="text-white/80 font-medium text-sm">{orderData.address}</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between px-4 py-3 bg-brand/5 rounded-2xl border border-brand/20">
                <span className="text-white/40 font-black text-xs uppercase tracking-widest">Total</span>
          ...
          <div className="px-8 pb-8 flex gap-3">
            <button
              onClick={onDismiss}
              className="flex-1 py-4 rounded-2xl bg-white/5 border border-white/10 text-white/60 font-black text-xs uppercase tracking-widest hover:bg-white/10 transition-all flex items-center justify-center gap-2"
            >
              <X className="w-4 h-4" />
              Dismiss
            </button>
            <button
              ...
              className="flex-[2] py-4 rounded-2xl bg-brand text-white font-black text-xs uppercase tracking-widest shadow-xl shadow-brand/30 hover:bg-orange-600 transition-all active:scale-95 flex items-center justify-center gap-2"
            >
