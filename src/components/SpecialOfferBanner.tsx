          ...
          <div className="w-full lg:w-1/2 p-8 md:p-16 space-y-8">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6 py-8 border-y border-white/5">
              ...
              <div className="flex flex-col">
                <p className="text-white/30 text-[10px] font-black uppercase tracking-[3px]">Special Price</p>
                <div className="flex items-center gap-4">
                  <span className="text-4xl font-black italic text-white tracking-tighter">₹{specialItem.price}</span>
                  <span className="text-xl font-black italic text-white/20 line-through tracking-tighter">₹{specialItem.originalPrice}</span>
                </div>
              </div>
            </div>
