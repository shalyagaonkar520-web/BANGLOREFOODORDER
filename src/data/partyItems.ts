...
export const NORMAL_CAKES: Product[] = [
  // Half Kg (0.5kg) - ₹200
  { id: 'cake-1-05', name: 'Black Forest (0.5kg)', price: 200, originalPrice: 400, category: 'Normal Cakes', type: 'food', image: '/black_forest_cake.png', description: 'Classic black forest cake.', isVeg: true },
  { id: 'cake-2-05', name: 'White Forest (0.5kg)', price: 200, originalPrice: 400, category: 'Normal Cakes', type: 'food', image: '/white_forest_cake.png', description: 'Elegant white forest cake.', isVeg: true },
  { id: 'cake-3-05', name: 'Red Forest (0.5kg)', price: 200, originalPrice: 400, category: 'Normal Cakes', type: 'food', image: '/red_forest_cake.jpg', description: 'Vibrant red forest cake.', isVeg: true },
  { id: 'cake-4-05', name: 'Purple Velvet (0.5kg)', price: 200, originalPrice: 400, category: 'Normal Cakes', type: 'food', image: '/purple_velvet_cake.png', description: 'Unique purple velvet cake.', isVeg: true },

  // 1 Kg (1kg) - ₹400
  { id: 'cake-1-1', name: 'Black Forest (1kg)', price: 400, originalPrice: 800, category: 'Normal Cakes', type: 'food', image: '/black_forest_cake.png', description: 'Classic black forest cake.', isVeg: true },
  { id: 'cake-2-1', name: 'White Forest (1kg)', price: 400, originalPrice: 800, category: 'Normal Cakes', type: 'food', image: '/white_forest_cake.png', description: 'Elegant white forest cake.', isVeg: true },
  { id: 'cake-3-1', name: 'Red Forest (1kg)', price: 400, originalPrice: 800, category: 'Normal Cakes', type: 'food', image: '/red_forest_cake.jpg', description: 'Vibrant red forest cake.', isVeg: true },
  { id: 'cake-4-1', name: 'Purple Velvet (1kg)', price: 400, originalPrice: 800, category: 'Normal Cakes', type: 'food', image: '/purple_velvet_cake.png', description: 'Unique purple velvet cake.', isVeg: true },
];
